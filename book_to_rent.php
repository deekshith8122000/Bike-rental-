...
<div class="container-fluid">
    <form action="" id="book-form">
        ...
        <div class="form-group">
            ...
            <input type="date" name="date_start" id="date_start" class="form-control form-conrtrol-sm rounded-0"  min="<?php echo date("Y-m-d"); ?>" value="" required>
        </div>
        <div class="form-group">
            <label for="date_end" class="control-label">Date to Return</label>
            <input type="date" name="date_end" id="date_end" class="form-control form-conrtrol-sm rounded-0" min="<?php echo date("Y-m-d"); ?>" value="" required>
        </div>
